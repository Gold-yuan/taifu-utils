...
public class ExcelUtil<T> {
    ...
    public static void main(String[] args) {
        ...
        TestEntity te = new TestEntity("13123456789", 1);
        TestEntity te2 = new TestEntity("131234567sdf9", 0);
        list.add(te);
        list.add(te2);
        ExcelUtil<TestEntity> util = new ExcelUtil<TestEntity>(TestEntity.class);
        util.exportExcel(list, "应收账款");
    }
                        ...
                        try {
                            ...
                            if (attr.isExport()) {
                                ...
                                if (StringUtils.isNotEmpty(dateFormat)) {
                                    cell.setCellValue(CommonUtils.dateFormat((Date) field.get(vo), dateFormat));
                                    ...
                                    cell.setCellType(CellType.STRING);
                                    // 如果数据存在就填入,不存在填入空格.
                                    cell.setCellValue(ObjectUtils.isEmpty(field.get(vo)) ? attr.defaultValue()
    ...
    public String encodingFilename(String filename) {
        filename = filename + CommonUtils.getRandomStr(10) + ".xls";
        return filename;
    }
